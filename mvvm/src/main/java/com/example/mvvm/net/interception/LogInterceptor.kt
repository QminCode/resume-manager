package com.example.mvvm.net.interception

import android.util.Log
import com.example.mvvm.net.interception.logging.DefaultFormatPrinter
import com.example.mvvm.net.interception.logging.FormatPrinter
import com.example.mvvm.net.interception.logging.util.CharacterHandler.Companion.jsonFormat
import com.example.mvvm.net.interception.logging.util.UrlEncoderUtils.Companion.hasUrlEncoded
import com.example.mvvm.net.interception.logging.util.ZipHelper.Companion.decompressForGzip
import com.example.mvvm.net.interception.logging.util.ZipHelper.Companion.decompressToStringForZlib
import okhttp3.*
import okio.Buffer
